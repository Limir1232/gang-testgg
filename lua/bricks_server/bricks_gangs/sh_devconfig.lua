...
BRICKS_SERVER.DEVCONFIG.GangNameCharLimit = 30
...
if( BRICKS_SERVER.Func.IsSubModuleEnabled( "gangs", "printers" ) ) then
    ...
    BRICKS_SERVER.DEVCONFIG.GangPrinterW = 807
    BRICKS_SERVER.DEVCONFIG.GangPrinterH = 1018
end
...
BRICKS_SERVER.DEVCONFIG.GangNotifications = {
    ["GangInvite"] = {
        ...
        AcceptFunc = function( reqInfo ) 
            net.Start( "BricksServerNet_GangInviteAccept" )
    ...
    ["AssociationInvite"] = {
        ...
        AcceptFunc = function( reqInfo ) 
            net.Start( "BricksServerNet_AcceptGangAssociation" )
                net.WriteUInt( reqInfo[1], 16 )
            net.SendToServer()
        end
    },
    ...
    ["AchievementReward"] = {
        ...
        AcceptFunc = function( reqInfo, inboxKey ) 
            net.Start( "BricksServerNet_GangAchievementClaim" )
