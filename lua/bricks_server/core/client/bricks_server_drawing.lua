...
hook.Add( "OnScreenSizeChanged", "BricksServerHooks_OnScreenSizeChanged_Fonts", createFonts )
...
hook.Add( "HUDPaint", "BricksServerHooks_HUDPaint_EntityToolTips", function()
...
hook.Add( "EntityRemoved", "BricksServerHooks_EntityRemoved_RemoveEntityToolTips", function( ent )
