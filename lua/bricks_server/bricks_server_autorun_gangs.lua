...
local module = BRICKS_SERVER.Func.AddModule( "gangs", "Brick's Gangs", "materials/bricks_server/gangs.png", "1.4.9" )
...
hook.Add( "BRS_BaseConfigLoad", "BricksServerHooks_BRS_BaseConfigLoad_Gangs", function()
    AddCSLuaFile( "bricks_server/bricks_gangs/sh_baseconfig.lua" )
    include( "bricks_server/bricks_gangs/sh_baseconfig.lua" )
end )

hook.Add( "BRS_ClientConfigLoad", "BricksServerHooks_BRS_ClientConfigLoad_Gangs", function()
    AddCSLuaFile( "bricks_server/bricks_gangs/sh_clientconfig.lua" )
    include( "bricks_server/bricks_gangs/sh_clientconfig.lua" )
end )

hook.Add( "BRS_DevConfigLoad", "BricksServerHooks_BRS_DevConfigLoad_Gangs", function()
...
if( SERVER ) then
    ...
    hook.Add( "BRS_SQLLoad", "BricksServerHooks_BRS_SQLLoad_Gangs", function()
