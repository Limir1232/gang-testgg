...
net.Receive( "BricksServerNet_OpenGangMenu", function()
...
net.Receive( "BricksServerNet_GangNetworkMessage", function()
	...
	hook.Run( "BRS_InsertGangChat", messageKey )
end )
...
function BRICKS_SERVER.Func.RequestPlyGangInfo( plySteamID )
	...
	net.Start( "BricksServerNet_RequestPlyGangInfo" )
		net.WriteString( plySteamID )
    net.SendToServer()
end

net.Receive( "BricksServerNet_SendPlyGangInfo", function()
