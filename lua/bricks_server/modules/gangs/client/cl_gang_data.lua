net.Receive( "BricksServerNet_SetGangID", function()
    BRS_GANGID = net.ReadUInt( 16 )
    
    timer.Simple( 0.1, function() 
        hook.Run( "BRS_RefreshGang" ) 
    end )
end )

net.Receive( "BricksServerNet_SetGangTable", function()
...
net.Receive( "BricksServerNet_SetGangTableValues", function()
    local gangID = net.ReadUInt( 16 )
    ...
    hook.Run( "BRS_RefreshGang", valuesChanged )
end )

net.Receive( "BricksServerNet_SetGangTableValue", function()
    local gangID = net.ReadUInt( 16 )
    ...
    hook.Run( "BRS_RefreshGang", { [tableKey] = true } )
end )