...
function PANEL:Init()
    ...
    hook.Add( "BRS_RefreshGang", self, function(  self, valuesChanged, refreshGang )
    ...
    hook.Add( "BRS_ConfigReceived", self, function( self, valuesChanged )
        if( IsValid( self ) ) then
...
function PANEL:RefreshGang()
    ...
    for k, v in pairs( pages ) do
        ...
        page:Dock( FILL )
        page.panelWide = ScrW()*0.6-BRICKS_SERVER.DEVCONFIG.MainNavWidth
