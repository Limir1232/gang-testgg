util.AddNetworkString( "BricksServerNet_AddGangAdminMail" )
net.Receive( "BricksServerNet_AddGangAdminMail", function( len, ply ) 
...
util.AddNetworkString( "BricksServerNet_RequestAdminGangs" )
util.AddNetworkString( "BricksServerNet_SendAdminGangTables" )
net.Receive( "BricksServerNet_RequestAdminGangs", function( len, ply ) 
	if( not BRICKS_SERVER.Func.HasAdminAccess( ply ) ) then return end
	...
	net.Start( "BricksServerNet_SendAdminGangTables" )
		net.WriteTable( sortedGangs )
	net.Send( ply )
end )

util.AddNetworkString( "BricksServerNet_RequestAdminGangData" )
util.AddNetworkString( "BricksServerNet_SendAdminGangData" )
net.Receive( "BricksServerNet_RequestAdminGangData", function( len, ply ) 
	if( not BRICKS_SERVER.Func.HasAdminAccess( ply ) ) then return end

	local gangID = net.ReadUInt( 16 )

	net.Start( "BricksServerNet_SendAdminGangData" )
		net.WriteUInt( gangID, 16 )
		net.WriteTable( BRICKS_SERVER_GANGS[gangID] or {} )
	net.Send( ply )
end )

util.AddNetworkString( "BricksServerNet_AdminGangCMD" )
net.Receive( "BricksServerNet_AdminGangCMD", function( len, ply ) 
	if( not BRICKS_SERVER.Func.HasAdminAccess( ply ) ) then return end
