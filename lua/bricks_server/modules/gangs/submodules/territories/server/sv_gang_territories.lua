...
util.AddNetworkString( "BricksServerNet_SendTerritoryGangTables" )
function BRICKS_SERVER.Func.SendTerritoryGangTables( ply )
    ...
    net.Start( "BricksServerNet_SendTerritoryGangTables" )
        net.WriteTable( gangsToSend )
    net.Send( ply )
end

util.AddNetworkString( "BricksServerNet_SendGangTerritoriesTable" )
hook.Add( "BRS_PlayerGangInitialize", "BricksServerHooks_BRS_PlayerGangInitialize_GangTerritories", function( ply )	
    if( BRS_GANG_TERRITORIES ) then
        net.Start( "BricksServerNet_SendGangTerritoriesTable" )
...
util.AddNetworkString( "BricksServerNet_SendGangTerritoriesValue" )
util.AddNetworkString( "BricksServerNet_SendTerritoryGangValues" )
...
function BRICKS_SERVER.Func.GangUnCaptureTerritory( gangID, territoryKey )
    ...
    net.Start( "BricksServerNet_SendGangTerritoriesValue" )
...
util.AddNetworkString( "BricksServerNet_RequestTerritoryGangs" )
net.Receive( "BricksServerNet_RequestTerritoryGangs", function( len, ply )
