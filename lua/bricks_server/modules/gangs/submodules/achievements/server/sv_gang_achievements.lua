...
hook.Add( "BRS_GangBalanceChanged", "BricksServerHooks_BRS_GangBalanceChanged_Achievements", function( gangID, newBalance )
...
hook.Add( "BRS_GangMembersChanged", "BricksServerHooks_BRS_GangMembersChanged_Achievements", function( gangID, newMemberCount )
	for k, v in pairs( BRICKS_SERVER.CONFIG.GANGS.Achievements or {} ) do
...
if( BRICKS_SERVER.Func.IsSubModuleEnabled( "gangs", "storage" ) ) then
	hook.Add( "BRS_GangStorageChanged", "BricksServerHooks_BRS_GangStorageChanged_Achievements", function( gangID, newStorageCount )
		for k, v in pairs( BRICKS_SERVER.CONFIG.GANGS.Achievements or {} ) do
...
hook.Add( "BRS_GangLevelChanged", "BricksServerHooks_BRS_GangLevelChanged_Achievements", function( gangID, newLevel )
	for k, v in pairs( BRICKS_SERVER.CONFIG.GANGS.Achievements or {} ) do
...
util.AddNetworkString( "BricksServerNet_GangAchievementClaim" )
net.Receive( "BricksServerNet_GangAchievementClaim", function( len, ply ) 
