...
util.AddNetworkString( "BricksServerNet_SendGangAssociations" )
function BRICKS_SERVER.Func.SendGangAssociations( ply )
	...
	net.Start( "BricksServerNet_SendGangAssociations" )
		net.WriteTable( associationsTable )
	net.Send( ply )
end

hook.Add( "BRS_PlayerGangInitialize", "BricksServerHooks_BRS_PlayerGangInitialize_GangAssociations", BRICKS_SERVER.Func.SendGangAssociations )

util.AddNetworkString( "BricksServerNet_SendGangAssociationValue" )
function BRICKS_SERVER.Func.GangsSetAssociation( gang1ID, gang2ID, associationType )
	...
	if( #onlineMembers > 0 ) then
		net.Start( "BricksServerNet_SendGangAssociationValue" )
...
util.AddNetworkString( "BricksServerNet_RequestAssociationGangs" )
util.AddNetworkString( "BricksServerNet_SendAssociationGangTables" )
net.Receive( "BricksServerNet_RequestAssociationGangs", function( len, ply ) 
	...
	net.Start( "BricksServerNet_SendAssociationGangTables" )
		net.WriteTable( sortedGangs )
	net.Send( ply )
end )

util.AddNetworkString( "BricksServerNet_RequestGangAssociation" )
net.Receive( "BricksServerNet_RequestGangAssociation", function( len, ply ) 
...
util.AddNetworkString( "BricksServerNet_AcceptGangAssociation" )
net.Receive( "BricksServerNet_AcceptGangAssociation", function( len, ply ) 
...
util.AddNetworkString( "BricksServerNet_DissolveGangAssociation" )
net.Receive( "BricksServerNet_DissolveGangAssociation", function( len, ply ) 
