net.Receive( "BricksServerNet_SendGangAssociations", function()
    ...
    hook.Run( "BRS_RefreshGangAssociations" )
end )

net.Receive( "BricksServerNet_SendGangAssociationValue", function()
...
net.Receive( "BricksServerNet_SendAssociationGangTables", function()
    hook.Run( "BRS_RefreshGangAssociations", net.ReadTable() or {} )
end )
...
function BRICKS_SERVER.Func.RequestAssociationGangs( searchString )
    ...
    net.Start( "BricksServerNet_RequestAssociationGangs" )
