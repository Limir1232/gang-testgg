			...
			for i = 1, maxSlots do
				...
				if( gangStorage[i] ) then
					...
					if( canCombine ) then
						...
						hook.Run( "BRS_GangStorageChanged", gangID, BRICKS_SERVER.Func.GangGetStorageCount( gangID ) )
...
util.AddNetworkString( "BricksServerNet_GangDepositLoadout" )
net.Receive( "BricksServerNet_GangDepositLoadout", function( len, ply ) 
...
if( BRICKS_SERVER.Func.IsSubModuleEnabled( "essentials", "inventory" ) ) then
	util.AddNetworkString( "BricksServerNet_GangDepositInventory" )
	net.Receive( "BricksServerNet_GangDepositInventory", function( len, ply ) 
		...
		if( inventoryTable[itemKey] ) then
			...
			ply:SetInventory( inventoryTable )
...
util.AddNetworkString( "BricksServerNet_GangStorageDrop" )
net.Receive( "BricksServerNet_GangStorageDrop", function( len, ply ) 
...
util.AddNetworkString( "BricksServerNet_GangStorageUse" )
net.Receive( "BricksServerNet_GangStorageUse", function( len, ply ) 
	local itemKey = net.ReadUInt( 10 )
	...
	local preventUse, errorMessage = hook.Run( "BRS_GangStorageCanUse", ply, itemKey )
