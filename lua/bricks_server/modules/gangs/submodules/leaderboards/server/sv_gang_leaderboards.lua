...
hook.Add( "BRS_GangDataLoaded", "BricksServerHooks_BRS_GangDataLoaded_GangLeaderboards", function()
...
util.AddNetworkString( "BricksServerNet_SendLeaderboardGangTables" )
function BRICKS_SERVER.Func.SendLeaderboardGangTables( ply )
    ...
    net.Start( "BricksServerNet_SendLeaderboardGangTables" )
        net.WriteTable( gangsToSend )
    net.Send( ply )
end

util.AddNetworkString( "BricksServerNet_RequestLeaderboardGangs" )
net.Receive( "BricksServerNet_RequestLeaderboardGangs", function( len, ply )
...
util.AddNetworkString( "BricksServerNet_SendGangLeaderboardTables" )
function BRICKS_SERVER.Func.SendGangLeaderboardTables( ply )
    net.Start( "BricksServerNet_SendGangLeaderboardTables" )
        net.WriteTable( BRS_GANG_LEADERBOARDS or {} )
    net.Send( ply )
end

util.AddNetworkString( "BricksServerNet_RequestGangLeaderboards" )
net.Receive( "BricksServerNet_RequestGangLeaderboards", function( len, ply )
    if( CurTime() < (ply.BRS_REQUEST_GANGLEADERBOARDS_COOLDOWN or 0) ) then return end

    ply.BRS_REQUEST_GANGLEADERBOARDS_COOLDOWN = CurTime()+10

    BRICKS_SERVER.Func.SendGangLeaderboardTables( ply )
end )

hook.Add( "BRS_PlayerGangInitialize", "BricksServerHooks_BRS_PlayerGangInitialize_GangLeaderboards", function( ply )
    BRICKS_SERVER.Func.SendGangLeaderboardTables( ply )
    BRICKS_SERVER.Func.SendLeaderboardGangTables( ply )
end )