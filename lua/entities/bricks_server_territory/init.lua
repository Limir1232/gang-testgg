...
function ENT:StartCapture( ply )
	...
	hook.Run( "BRS_GangStartCapture", ply, ((BRICKS_SERVER.CONFIG.GANGS.Territories or {})[territoryKey] or {}).Name or "NIL" )
end
...
function ENT:StartUnCapture( ply )
	...
	hook.Run( "BRS_GangStartUnCapture", ply, ((BRICKS_SERVER.CONFIG.GANGS.Territories or {})[territoryKey] or {}).Name or "NIL" )
end
